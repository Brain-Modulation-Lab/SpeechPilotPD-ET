function [mi,amp_ph,zmi,surrdis]=cfcMI4(ph,amp,nbin,niter,parallel)
...
for n=1:niter
%     shift=randperm(ar,round(ar/35))';
%     x=setdiff(1:ar,shift);
%     shift2=x(randperm(round(ar-(ar/35)),length(shift)))';
%     samp(shift,n)=samp(shift2,n);
